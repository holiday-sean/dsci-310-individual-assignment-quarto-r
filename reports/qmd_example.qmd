...
![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-horse-saskatchewan width=60%}

In @fig-horse-saskatchewan we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
